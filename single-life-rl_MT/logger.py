...
#                 should_write_header = False
        ...
        self._csv_writer = csv.DictWriter(self._csv_file,
                                          fieldnames=sorted(['success_avg', 'episode', 'episode_length', 'episode_reward', 'forward_buffer_size', 'fps', 'frame', 'step', 'total_time', 'critic_loss', 'actor_logprob', 'alpha_loss', 'batch_reward', 'alpha_value', 'actor_loss', 'critic_q1', 'critic_q2', 'original_reward', 'critic_target_q', 'discriminator_loss', 'bc_actor_loss', 'latest_r', 'disc_s', 'disc_s_stk', 'disc_s_acc', 'disc_s_stk_acc', 'discriminator_acc']),
                                          restval=0.0)
